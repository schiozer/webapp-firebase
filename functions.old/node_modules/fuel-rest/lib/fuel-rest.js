...
const FuelAuth = require('fuel-rest/lib/node_modules/fuel-auth');
const helpers = require('fuel-rest/lib/helpers');
const request = require('fuel-rest/lib/node_modules/request');
const version = require('fuel-rest/package.json').version;

const clone = require('fuel-rest/lib/node_modules/lodash.clone');
const merge = require('fuel-rest/lib/node_modules/lodash.merge');
const isPlainObject = require('fuel-rest/lib/node_modules/lodash.isplainobject');
